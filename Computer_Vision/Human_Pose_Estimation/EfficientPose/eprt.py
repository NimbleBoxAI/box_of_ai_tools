"""
This code is merely a wrapper for the original code in this repo: https://github.com/daniegr/EfficientPose
I have merely made it's use simpler. Don't hate me when you see the code! - @yashbonde
"""
from helper import pytorch_BilinearConvTranspose2d
...
class KitModel(nn.Module):
    ...
    def __transposed(channels, kernel_size, stride):
        return pytorch_BilinearConvTranspose2d(channels=channels, kernel_size=kernel_size, stride=stride)
